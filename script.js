...
define('canvas', ['exports', 'grid', 'point_sampler', 'options', 'utils'], function (exports, _grid, _point_sampler, _options, _utils) {
  'use strict';
  ...
  var _point_sampler2 = _interopRequireDefault(_point_sampler);
...
define('grid', ['exports', 'line', 'options'], function (exports, _line, _options) {
  'use strict';
    ...
    function Grid(width, height) {
      ...
      for (var row = 0; row < this.rows; row++) {
        for (var column = 0; column < this.columns; column++) {
          ...
          this.array[row * this.columns + column] = new _line2.default(x, y);
        }
      }
    }
...
define('line', ['exports', 'utils', 'options'], function (exports, _utils, _options) {
  'use strict';
...
define("options", ["exports"], function (exports) {
  ...
  var pow = Math.pow,
      sqrt = Math.sqrt;
  var lineSpacing = exports.lineSpacing = 3;
  var lineLength = exports.lineLength = 50;
  var lineHue = exports.lineHue = 0;
  var lineSaturation = exports.lineSaturation = 0;
  var lineAlpha = exports.lineAlpha = 0.35;
  var lineTint = exports.lineTint = 0.15;
  var lineLightness = exports.lineLightness = 1 - lineTint;
  ...
  var brushProfile = exports.brushProfile = brushProfiles.sharp;
  var brushSize = exports.brushSize = 30;
  var brushLength = exports.brushLength = 20;
  var brushEffect = exports.brushEffect = 0.15;
});
define('point_sampler', ['exports', 'utils'], function (exports, _utils) {
  'use strict';
...
require(['main'], function(main) { main.default(); });
